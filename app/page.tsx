...
export default function LandingPage() {
  return (
    <div className="min-h-screen selection:bg-green-500/30 flex flex-col">
      {/* Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="font-bold text-xl tracking-tight">
            NoShow<span className="text-green-500">Kill</span>
          </div>
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <Link href="/login" className="text-sm font-medium hover:text-green-500 transition-colors">
              Connexion
            </Link>
            <Link 
              href="/register" 
              className="text-sm bg-zinc-950 text-white dark:bg-white dark:text-zinc-950 px-4 py-2 rounded-full font-medium hover:opacity-80 transition-opacity"
            >
      ...
      <main className="flex-1 pt-32 pb-24">
        ...
        <section className="max-w-4xl mx-auto px-4 text-center mb-24">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 text-green-500 text-sm font-medium mb-6 border border-green-500/20">
            <TrendingDown className="w-4 h-4" />
            La fin des tables vides
          </div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
            Vos no-shows vous coûtent <span className="text-green-500">1 200€</span> par mois.<br/>
            On arrête ça.
          </h1>
          ...
          <div className="flex flex-col items-center gap-4">
            <Link 
              href="/register" 
              className="inline-flex items-center justify-center gap-2 bg-zinc-950 text-white dark:bg-white dark:text-zinc-950 px-8 py-4 rounded-full text-lg font-bold hover:scale-105 transition-transform"
            >
        ...
        {/* Trust Banner */}
        <div className="border-y border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 py-8 mb-24">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <p className="text-sm text-zinc-500 dark:text-zinc-400 font-medium tracking-widest uppercase mb-6">
              Déjà utilisé par des restaurants à Paris, Lyon, Marseille, Bordeaux
            </p>
            <div className="flex flex-wrap justify-center gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              <div className="text-xl font-bold font-serif italic flex items-center gap-2">
                <Star className="w-5 h-5 fill-current" /> Le Petit Bistrot
              </div>
              <div className="text-xl font-bold tracking-tight flex items-center gap-2">
                <Star className="w-5 h-5 fill-current" /> MAISON D'HÔTE
              </div>
              <div className="text-xl font-medium tracking-widest flex items-center gap-2">
                <Star className="w-5 h-5 fill-current" /> CAFE M
              </div>
              <div className="text-xl font-semibold uppercase flex items-center gap-2">
        ...
        <section className="max-w-5xl mx-auto px-4 mb-32">
          <div className="bg-zinc-50 dark:bg-zinc-900 rounded-3xl p-8 md:p-12 border border-green-500/20 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-8 opacity-10">
              <TrendingDown className="w-64 h-64 text-green-500" />
            </div>
            <div className="relative z-10 max-w-2xl">
              ...
              <div className="space-y-4 text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed">
                ...
                <p>
                  <span className="text-green-500 font-semibold">15 à 20%</span> de vos réservations finissent en no-show. 
                  2 tables vides par service = 70€ perdus = <strong className="text-zinc-900 dark:text-white">2 100€ par mois qui s'évaporent</strong>.
                </p>
                <p className="pt-4 border-t border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 text-base">
        ...
        <section className="max-w-5xl mx-auto px-4 mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zinc-600 dark:text-zinc-400">Une intégration invisible, des résultats immédiats.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors">
                <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center mb-6">
                  {step.icon}
                </div>
        ...
        <section className="max-w-5xl mx-auto px-4 mb-32 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="text-6xl text-zinc-300 dark:text-zinc-800 mb-4 font-serif">"</div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center font-bold text-xl">
                M
              </div>
              <div>
                <div className="font-bold">Mohammed R.</div>
                <div className="text-sm text-zinc-500 dark:text-zinc-400">Restaurateur à Lyon</div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                <CheckCircle2 className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span className="font-medium text-zinc-800 dark:text-zinc-200">{stat}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto px-4 mb-24">
          <div className="bg-zinc-50 dark:bg-gradient-to-b dark:from-zinc-900 dark:to-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-green-300 to-green-600"></div>
            ...
            <Link 
              href="/register" 
              className="block w-full max-w-sm mx-auto bg-zinc-950 text-white dark:bg-white dark:text-zinc-950 py-4 rounded-xl text-lg font-bold hover:opacity-80 transition-opacity mb-6 shadow-xl"
            >
              Commencer gratuitement →
            </Link>
            
            <div className="bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 text-green-700 dark:text-green-400 p-4 rounded-xl text-sm leading-relaxed max-w-md mx-auto">
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 py-12 text-center text-zinc-500">
        <div className="max-w-5xl mx-auto px-4">
          <div className="font-bold text-xl tracking-tight text-foreground mb-6">
            NoShow<span className="text-green-500">Kill</span>
          </div>
          <div className="flex justify-center gap-6 text-sm mb-8">
            <Link href="#" className="hover:text-green-500 transition-colors">Mentions légales</Link>
            <Link href="#" className="hover:text-green-500 transition-colors">Confidentialité</Link>
